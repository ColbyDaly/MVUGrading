...
public class Spreadsheet {
	...
	public static void main(String[] args) {
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
               ...
               // count = 1;
                ...
                while ((line = br.readLine()) != null) {
                	...
                	if(list[i].projectNumber.equals(country[0])){
                		
                		// set fname lname 
                		list[i].fname = country[2];
                		list[i].lname = country[1];
                	}
        ...
        try {
        	...
        	fileWriter.append("\n");
        	fileWriter.append("\n");
        	fileWriter.append("Rank, Project Number, First Name, Last Name, Grade, Avg Score, Category, Number of judges");
        	fileWriter.append("\n");
        	for(int i = list.length - 1; i >= 0; i--){
        		if(list[i] != null){
        		fileWriter.append(n + "," + list[i].projectNumber.toString() + "," + list[i].fname + "," + list[i].lname + "," +list[i].gradeLevel + "," + list[i].avg + "," + list[i].category.toString() + "," + list[i].numJudges);
        		fileWriter.append("\n");
        		n = n+1;
        	...
        	for(int i = grade7.length - 1; i >= 0; i--){
        		if(grade7[i] != null){
        		fileWriter.append(n + "," + grade7[i].projectNumber.toString() + ","+ grade7[i].fname + "," + grade7[i].lname + ","  + grade7[i].gradeLevel + "," + grade7[i].avg + "," + grade7[i].category.toString() + "," +  grade7[i].numJudges);
        		fileWriter.append("\n");
        		n = n+1;
        	...
        	fileWriter.append("\n");
        	fileWriter.append("\n");
        	fileWriter.append("Rank, Project Number, First Name, Last Name, Grade, Avg Score, Number of judges");
        	fileWriter.append("\n");
        	for(int i = physics.length - 1; n <= 5; i--){
        		if(physics[i] != null){
        		fileWriter.append(n + "," + physics[i].projectNumber.toString() + ","+ physics[i].fname + "," + physics[i].lname + ","  + physics[i].gradeLevel + "," + physics[i].avg + "," + physics[i].numJudges);
        		fileWriter.append("\n");
        		n = n+1;
        	...
        	for(int i = bio.length - 1; n <= 5; i--){
        		if(bio[i] != null){
        		fileWriter.append(n + "," + bio[i].projectNumber.toString() + ","+ bio[i].fname + "," + bio[i].lname + ","  + bio[i].gradeLevel + "," + bio[i].avg + "," + bio[i].numJudges);
        		fileWriter.append("\n");
        		n = n+1;
        	...
        	for(int i = chem.length - 1; n <= 5; i--){
        		if(chem[i] != null){
        		fileWriter.append(n + "," + chem[i].projectNumber.toString() + "," + chem[i].fname + "," + chem[i].lname + "," + chem[i].gradeLevel + "," + chem[i].avg + "," + chem[i].numJudges);
        		fileWriter.append("\n");
        		n = n+1;
        	...
        	for(int i = social.length - 1; n <= 5; i--){
        		if(social[i] != null){
        		fileWriter.append(n + "," + social[i].projectNumber.toString() + ","+ social[i].fname + "," + social[i].lname + ","  + social[i].gradeLevel + "," + social[i].avg + "," + social[i].numJudges);
        		fileWriter.append("\n");
        		n = n+1;
        	...
        	for(int i = energy.length - 1; n <= 5; i--){
        		if(energy[i] != null){
        		fileWriter.append(n + "," + energy[i].projectNumber.toString() + "," + energy[i].fname + "," + energy[i].lname + "," + energy[i].gradeLevel + "," + energy[i].avg + "," + energy[i].numJudges);
        		fileWriter.append("\n");
        		n = n+1;
